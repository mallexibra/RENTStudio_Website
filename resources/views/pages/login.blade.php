...
<body>
    ...
    <div class="d-flex min-vh-100 flex-column align-items-center justify-content-center">
        ...
        <form style="min-width: 390px; max-width: 520px" class="p-3 border rounded mt-5" action="/login" method="post">
            @method('POST')
            @csrf
            ...
            <button class="btn w-100 btn-purple" type="submit">Login Now</button>
            <p class="mt-3 text-center">Don't have an account yet? <a style="text-decoration: none" class="fw-semibold"
                    href="/register">Signup now</a>
            </p>
        </form>
    </div>
