...
@section('content')
    ...
    <form action="/admin/account/edit/{{ $profile['id'] }}" method="POST" enctype="multipart/form-data" class="mx-auto mt-5"
        style="max-width: 35%">
        @method('POST')
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" required name="email" name="email" value="{{ $profile['email'] }}"
                class="form-control" id="email" placeholder="johndea@rent.com">
        </div>
        <div class="mb-3">
        ...
        <a href="/admin/account" class="btn mb-5 w-100 btn-red">Cancel Edit Profile</a>
    </form>
